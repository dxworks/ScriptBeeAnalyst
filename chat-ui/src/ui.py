...
async def on_message(message: cl.Message):
    ...
    shared_state['last_answer'] = cl.Message(content="Thinking ...")
    await  shared_state['last_answer'].send()
    ...
    shared_state['last_answer'].content = response
    await shared_state['last_answer'].update()
