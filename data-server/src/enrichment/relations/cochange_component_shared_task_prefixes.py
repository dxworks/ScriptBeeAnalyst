"""Component↔Component aggregation of `cochange.file-file.shared-task-prefixes`."""
...
class ComponentSharedTaskPrefixesExtractor:

    KIND = "cochange.component-component.shared-task-prefixes"
    SOURCE_KIND = "cochange.file-file.shared-task-prefixes"
