"""Component↔Component aggregation of `cochange.file-file.time-windowed`."""
...
class ComponentTimeWindowedExtractor:

    KIND = "cochange.component-component.time-windowed"
    SOURCE_KIND = "cochange.file-file.time-windowed"
