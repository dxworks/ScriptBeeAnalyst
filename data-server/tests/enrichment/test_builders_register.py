...
import src.enrichment.relations.implementations  # noqa: F401 — side-effect import
from src.enrichment.relations import BUILDERS, BuilderRegistry, RelationBuilder
