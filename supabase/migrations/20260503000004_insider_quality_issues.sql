...
-- git/github/jira/lizard/metrixpp/jafax/codeframe/dude_external/dude_internal.
...
alter table public.serialized_files
  ...
  check (file_type in ('git', 'github', 'jira', 'lizard', 'metrixpp', 'jafax', 'codeframe', 'dude_external', 'dude_internal', 'quality_issues'));
