-- JaFax / CodeFrame code-structure cache: one JSONB blob per project.
...
-- the JaFax layout JSON at project load and stores the full set as a single
...
create table public.code_structure (
    ...
    source text not null default 'jafax',
...
-- Allow JaFax / CodeFrame layout JSONs to upload as serialized files.
